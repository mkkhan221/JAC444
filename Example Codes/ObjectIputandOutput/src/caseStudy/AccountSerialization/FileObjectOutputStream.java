package caseStudy.AccountSerialization;

//Writing objects to a file with class ObjectOutputStream.
...
public class FileObjectOutputStream{
	...
	public static void openFile(){
		try{
 		    output = new ObjectOutputStream(Files.newOutputStream(Paths.get("clinet.ser")));
